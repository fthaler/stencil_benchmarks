...
namespace backend {
    namespace openmp {
        ...
        class vadv_blocked : public vadv_stencil_base<Allocator> {
          public:
            ...
            vadv_blocked(const arguments_map &args) : vadv_stencil_base<Allocator>(args), m_blocked_execution(args) {}
            ...
            void run() override {
                ...
                real *__restrict__ datacol = this->m_datacol->data();
...
#pragma vector nontemporal(utensstage)
                                for (int inner_i = inner_max - 1; inner_i >= inner_ib; --inner_i) {
                                    this->backward_sweep_k(inner_i,
                                        outer_i,
                                        k,
                                        ccol,
                                        dcol,
