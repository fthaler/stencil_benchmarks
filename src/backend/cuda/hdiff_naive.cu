...
namespace backend {
    namespace cuda {
        ...
        void hdiff_naive::register_arguments(arguments &args) {
        ...
        hdiff_naive::hdiff_naive(const arguments_map &args)
        ...
        void hdiff_naive::run() {
            ...
            hdiff_naive_lap_kernel<<<blocks, threads>>>(lap, src, isize, jsize, ksize, istride, jstride, kstride);
            hdiff_naive_flx_kernel<<<blocks, threads>>>(flx, src, lap, isize, jsize, ksize, istride, jstride, kstride);
            hdiff_naive_fly_kernel<<<blocks, threads>>>(fly, src, lap, isize, jsize, ksize, istride, jstride, kstride);
