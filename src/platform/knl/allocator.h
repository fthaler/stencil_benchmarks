    ...
    namespace knl {
        ...
        struct allocator {
            ...
            value_type *allocate(std::size_t n) const {
                ...
                value_type *ptr = reinterpret_cast<value_type *>(reinterpret_cast<char *>(raw_ptr) + offset);
            ...
            void deallocate(value_type *ptr, std::size_t n) const {
                ...
                void *raw_ptr = reinterpret_cast<void *>(reinterpret_cast<char *>(ptr) - offset);
